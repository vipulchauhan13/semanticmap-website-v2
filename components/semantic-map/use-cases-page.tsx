...
export default function UseCasesPage() {
  ...
  const useCases = [
    {
      id: 1,
      title: t("Market Research & Consumer Insights"),
      ...
      benefits: [
        t("Drastically reduce analysis time by 98%"),
        t("Gain deeper, unbiased understanding of consumer motivations"),
        t("Identify emerging trends faster"),
        t("Validate hypotheses with qualitative data"),
        t("Make data-driven marketing and strategy decisions"),
      ],
    ...
    {
      id: 2,
      title: t("User Experience (UX) & Product Feedback"),
      ...
      benefits: [
        t("Quickly pinpoint critical usability issues"),
        t("Understand user journeys and friction points more effectively"),
        t("Prioritize product development based on direct user feedback"),
        t("Share clear, data-backed insights with design and development teams"),
        t("Reduce research costs by 97%"),
      ],
    ...
    {
      id: 3,
      title: t("Product Development & Innovation"),
      ...
      benefits: [
        t("Accelerate the innovation cycle"),
        t("Understand the 'why' behind preferences"),
        t("Optimize product features, messaging, and packaging based on detailed feedback"),
        t("Identify key differentiators and value propositions early on"),
        t("Make better decisions with comprehensive insights"),
      ],
    ...
    {
      id: 4,
      title: t("Brand Perception & Competitive Analysis"),
      ...
      benefits: [
        t("Gain objective insights into brand health"),
        t("Understand your competitive positioning from the customer's perspective"),
        t("Identify opportunities to strengthen brand messaging"),
        t("Inform strategic planning with rich qualitative context"),
        t("Track brand perception changes over time"),
      ],
    ...
    {
      id: 5,
      title: t("Academic Research & Qualitative Studies"),
      ...
      benefits: [
        t("Significantly reduce the time spent on transcription and initial thematic analysis"),
        t("Enhance the rigor and transparency of qualitative analysis through systematic AI-driven insights"),
        t("Facilitate the management and exploration of large, complex datasets"),
        t("Uncover nuanced findings and complex interrelationships within the data more efficiently"),
        t("Accelerate progress towards publications, thesis completion, and grant milestones"),
      ],
      features: [
    ...
    {
      id: 6,
      title: t("Sales Call Analysis & Customer Success Insights"),
      ...
      benefits: [
        t("Identify winning sales tactics and objection-handling techniques to replicate across the team"),
        t("Improve sales coaching and onboarding by providing data-backed examples of effective communication"),
        t("Gain faster insights into common customer pain points and needs to inform product development"),
        t("Proactively identify customers at risk of churn based on conversational cues or expressed concerns"),
        t("Enhance customer success strategies by understanding what truly drives value for different client segments"),
        t("Shorten sales cycles and improve win rates through optimized strategies"),
      ],
      features: [
        "Perfect Transcription",
        "Deep Analysis",
    ...
    <div className="relative min-h-screen w-full flex flex-col bg-black text-white overflow-hidden">
      ...
      <main className="relative z-10 flex-1 flex flex-col px-4 pt-8 pb-20">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            {t("From Raw Conversations to Actionable Strategy")}
          </motion.h1>
        ...
        <div className="container mx-auto mb-20">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">{t("Core AI Features")}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3">{t("Multi-Interview Analysis")}</h3>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3">{t("Custom Analysis")}</h3>
              <p className="text-white/70">
                {t(
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3">{t("Perfect Transcription")}</h3>
              <p className="text-white/70">
                {t(
        ...
        <div className="container mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">{t("Ready to Transform Your Research?")}</h2>
